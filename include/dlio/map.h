...
private:
  ...
  void callbackDeskewed(const sensor_msgs::msg::PointCloud2::ConstSharedPtr& deskewed);
  ...
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr deskewed_sub;
  ...
  pcl::PointCloud<PointType>::Ptr save_map;
